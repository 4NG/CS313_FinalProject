...
class openwin5():
    def __init__(self):
        a = newwin()
        self.canvas = a.frame
        img = PhotoImage(file="acc_test.png")
        img1 = PhotoImage(file="acc_train.png")
        img2 = PhotoImage(file="F1.png")
        img3 = PhotoImage(file="precison.png")
        img4 = PhotoImage(file="recall.png")
        img5 = PhotoImage(file="k-ford.png")
        img6 = PhotoImage(file="time.png")

        def open_img():
            c=newwin()
            self.canvas1=c.frame
            lable_3 = Label(self.canvas1)
            lable_3.config(image=img)
            self.canvas1.create_window(700,500, width=1920, height=1080, window=lable_3)
            #self.canvas1.create
        def open_img1():
            c=newwin()
            self.canvas1=c.frame
            lable_3 = Label(self.canvas1)
            lable_3.config(image=img1)
            self.canvas1.create_window(700,500, width=1920, height=1080, window=lable_3)
        ...
        def open_img6():
                ...
                self.canvas1 = c.frame
                lable_3 = Label(self.canvas1)
                lable_3.config(image=img6)
                self.canvas1.create_window(700, 500, width=1920, height=1080, window=lable_3)
        self.button = Button(self.canvas, text="Accuracy train",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img)
        self.id = self.canvas.create_window(100, 400, width=100, height=70, window=self.button)

        self.button1 = Button(self.canvas, text="Accuracy test",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img1)
        self.id1 = self.canvas.create_window(300, 400, width=100, height=70, window=self.button1)

        self.button2 = Button(self.canvas, text="F1 score",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img2)
        self.id2= self.canvas.create_window(500, 400, width=100, height=70, window=self.button2)

        self.button3 = Button(self.canvas, text="Precision",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img3)
        self.id3 = self.canvas.create_window(700, 400, width=100, height=70, window=self.button3)

        self.button4 = Button(self.canvas, text="Recall",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img4)
        self.id4 = self.canvas.create_window(900, 400, width=100, height=70, window=self.button4)

        self.button5 = Button(self.canvas, text="K-fold",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img5)
        self.id5 = self.canvas.create_window(1100, 400, width=100, height=70, window=self.button5)

        self.button6 = Button(self.canvas, text="Time",bg='black', fg='white',font=('helvetica', 10, 'bold'), command=open_img6)
        self.id6 = self.canvas.create_window(1300, 400, width=100, height=70, window=self.button6)
...
class CanvasButton:
    def __init__(self, canvas):
        ...
        self.lable = Label(canvas, text="application of team 17", font=fontStyle,bg='pink')
